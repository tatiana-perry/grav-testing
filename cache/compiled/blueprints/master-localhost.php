...
return [
    ...
    'timestamp' => 1558127004,
    'checksum' => 'aaa0b0123a8a64514f9e2714c46fd549',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/markdown-clipboard' => [
                'file' => 'user/plugins/markdown-clipboard/blueprints.yaml',
                'modified' => 1530014276
            ],
            ...
            'plugins/nomnoml-uml-diagrams' => [
                'file' => 'user/plugins/nomnoml-uml-diagrams/blueprints.yaml',
                'modified' => 1558126964
            ],
            'plugins/page-toc' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.markdown-clipboard.enabled' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ADMIN.PLUGIN_STATUS',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.markdown-clipboard.enabled',
                'validation' => 'strict'
            ],
            'plugins.markdown-clipboard.built_in_css' => [
                'type' => 'toggle',
                'label' => 'Built in CSS',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.markdown-clipboard.built_in_css',
                'validation' => 'strict'
            ],
            'plugins.markdown-notices' => [
                'type' => '_root',
            ...
            'plugins.nomnoml-uml-diagrams.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'options' => [
                    1 => 'Enabled',
                ...
                'name' => 'plugins.nomnoml-uml-diagrams.enabled',
                'validation' => 'strict'
            ],
            'plugins.nomnoml-uml-diagrams.builtin_css' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.nomnoml-uml-diagrams.builtin_css',
                'validation' => 'strict'
            ],
            'plugins.nomnoml-uml-diagrams.builtin_js' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.nomnoml-uml-diagrams.builtin_js',
                'validation' => 'strict'
            ],
            'plugins.nomnoml-uml-diagrams.defaultoptions' => [
                'type' => 'array',
                'label' => 'Default directives and styles',
                'required' => false,
                'name' => 'plugins.nomnoml-uml-diagrams.defaultoptions',
                'validation' => 'strict'
            ],
            'plugins.page-toc' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'markdown-clipboard' => [
                    'enabled' => 'plugins.markdown-clipboard.enabled',
                    'built_in_css' => 'plugins.markdown-clipboard.built_in_css'
                ],
                'markdown-notices' => [
                ...
                'nomnoml-uml-diagrams' => [
                    'enabled' => 'plugins.nomnoml-uml-diagrams.enabled',
                    'builtin_css' => 'plugins.nomnoml-uml-diagrams.builtin_css',
                    'builtin_js' => 'plugins.nomnoml-uml-diagrams.builtin_js',
                    'defaultoptions' => 'plugins.nomnoml-uml-diagrams.defaultoptions'
                ],
                'page-toc' => [
