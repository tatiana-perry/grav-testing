...
return [
    ...
    'checksum' => 'af4e093a469f8ba43d3d1505ad383cff',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'plugins/markdown-clipboard' => [
                'file' => 'user/config/plugins/markdown-clipboard.yaml',
                'modified' => 1530014276
            ],
            'plugins/page-toc' => [
        ...
        'user/plugins' => [
            ...
            'plugins/markdown-clipboard' => [
                'file' => 'user/plugins/markdown-clipboard/markdown-clipboard.yaml',
                'modified' => 1530014276
            ],
            ...
            'plugins/nomnoml-uml-diagrams' => [
                'file' => 'user/plugins/nomnoml-uml-diagrams/nomnoml-uml-diagrams.yaml',
                'modified' => 1558126964
            ],
            'plugins/page-toc' => [
